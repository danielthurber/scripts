...
```{r}
basin.name <- 'Rio Lucero' #user input
gaugenum <- '8271000' #user input
snoname <- 'Taos' #user input
snosite <- 1168 #user input
...
snoflo= data.frame(snodf[-seq(1,a),], row.names = seq(1,nrow(snodf)-a))
a <- NA
```
