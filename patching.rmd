...
i1 <- 61 #first index of choles to consider
...
plot(crossdf$qpatch, xlim=patch.int, type= 'l', main = sitename, ylab = 'discharge', col = 'seagreen2')
abline(v = qholes, col = 'red')
...
plot(crossdf$qpatch, xlim=patch.int, type= 'l', ylab = 'Discharge', 
     main = sitename, col = 'seagreen2', xlab = 'date', xaxt = 'n')
