...
dayticks <- c(124,153, 184,214,245,275,306,337) #water year days corresponding to the first of the month
ticklabs <- c('Feb 1','Mar 1','Apr 1','May 1','Jun 1','Jul 1','Aug 1','Sep 1')
...
par(cex = 1.2)
title(ylab = expression(Q~(m^3*"/"*s)), line =2)
#mtext('SWIT (mm)', side = 4, line = 2)
...
title(main = 'Logan River Subcatchments' , line = 1)
axis(1, at = dayticks, labels = ticklabs)

par(cex = 1.2)
title(ylab =  expression(Q[A]~(mm*'/'*hr)) ,xlab = 'Day of Year', line = 2)
...
par(cex = 1.2)
title(ylab = expression(Q[A]~(mm*'/'*hr)) ,xlab = 'Day of Year', line = 2, family = 'A')
...
```{r}
#use commenting to choose the desired set of sites to plot
choices <- c(1,6,7,11,12) #mainstem
