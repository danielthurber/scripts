...
win4 <- c(1350,1550)   #gray rect for 2018
...
plot(ccf1$lag, ccf1$acf, col=linecols[1],
     ...
     type = 'l', #change to 'n' to hide, 'l' to show
     )
...
```{r}
acf.df <- data.frame(lag = ccf1$lag) #create dataframe with lag times.  lagtimes for all acf functions must coincide
...
win3 <- c(960,1175)  #green rect for 2017
win4 <- c(1350,1550)   #gray rect for 2018
win5 <- c(1700,1920)   #blue rect for 2019
win6 <- c(2080,2290)   #brown rect for 2020
#win7 <- c(2000,2020) #2021
...
legend('bottomleft', legend = win.names[c(1,2,3,4,5,6)], lty = 1, col = linecols[c(1,2,3,4,5,6)]) 
```
...
```{r}
acf.df <- data.frame(lag = acf1$lag) #create dataframe with lag times.  lagtimes for all acf functions must coincide
#add columns for each 
...
legend('bottomleft', legend = win.names[c(1,2,3,4,5)], lty = 1, col = linecols[c(1,2,3,4,5)]) 
```
