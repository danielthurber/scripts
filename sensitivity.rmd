...
date.mark <- '10-30' #vertical yellow lines will be drawn at this date for reference
...
```{r}
study.int <- c(1630,1860) #redefine the study interval, or do so by re-running the chunk above
