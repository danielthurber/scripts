...
```
This plot will be useful for determining a window over which to characterize the CCF for a give water year
```{r}
a <- 210
b <- 450

win1 <- c(a+20,b-20)  #red rect
    #blue rect
