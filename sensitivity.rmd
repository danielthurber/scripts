...
```{r}
win.names <- c('dry season 16','water year 17','water year 18','wet season','full POR')
```
...
plot(ccf1$lag, ccf1$acf, type = 'l', col=linecols[1],
     ylab = 'Correlation', xlab = 'Lag (days)', ylim = c(-0.2,1), xlim = c(0,lagmax), 
     main = paste('SWIT Crosscorrelation window sensitivity:', sitename))
...
legend('topright', legend = win.names, lty = 1, col = linecols[1:5]) 
```
