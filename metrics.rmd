...
```{r}
i <-1#enter site INDEX for file upload and export
...
val <- 249#enter water year day to try: MSD~150, RSD~250, BSD <- 365
...
minroll <- min(rollmean(wydf$qpatch,7))
