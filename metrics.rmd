...
```{r}
i <- 4 #enter site INDEX for file upload and export
...
```{r}
new.col.name <- 'CV_VAA' #define the column name as a character string
new.col.values <- VAA #define all values in sequence, or reference a vector with them
